...
Your Key Vault address will show up under "Local Addresses". If you'd like to use this key as your vote signer key, you can follow [this guide](/home/protocol/governance/voting-in-governance-using-mondo) and replace `--useLedger` with `--useAKV --azureVaultName $AZURE_VAULT_NAME`.
