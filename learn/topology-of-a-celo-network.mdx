---
title: "Topology of a Celo Network"
sidebarTitle: "Celo Network Topology"
og:description: Introduction to the Celo Network's topology including validators, full nodes, light clients, and wallets.
---
