...
| RPC Endpoint (best effort) | https://forno.celo.org <br/> Note: [Forno](/network/node/forno#celo-mainnet) is rate limited, as your usage increases consider options that can provide the desired level of support (SLA).                          |
...
| Chain ID                   | 44787                                                                                                                                                                                                                          |
| Currency Symbol            | CELO                                                                                                                                                                                                                           |
| RPC Nodes                  | [List of RPC providers](/network/node/overview#as-a-service)                                                                                                                                                                         |
