...
<Warning>
For these to run, you may need to follow the [setup instructions](https://github.com/celo-org/celo-monorepo/blob/master/README.md). These steps include installing Node and setting `nvm` to use the correct version of Node. Successful `yarn install` and `yarn build` in the protocol package signal a completed setup.
</Warning>
    ...
    <td>
      <ol>
        ...
        <li>
          ...
          <a href="/home/protocol/governance/overview">governance process.</a>
          <ul>
            <li>
