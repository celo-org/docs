...
![Starter UI](./tutorial-assets/initial-ui.png)
...
![scan to pay page](./tutorial-assets/paypage.png)
...
![merchants balance](./tutorial-assets/merchantbalance.PNG)

And the user's mobile wallet on android, with a balance of 11.81229 CELO

![user balance](./tutorial-assets/userbalance.jpg)
...
![qr to pay](./tutorial-assets/paidqr.png)
