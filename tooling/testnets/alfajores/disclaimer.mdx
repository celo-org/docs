...
sidebarTitle: "Celo Alfajores Testnet Disclaimer"
og:description: Important considerations, warnings, and legal regulations for users of the Alfajores Testnet.
---
