...
_See code: [src/commands/identity/withdraw-attestation-rewards.ts](https://github.com/celo-org/developer-tooling/tree/%40celo/celocli%408.0.2/packages/cli/src/commands/identity/withdraw-attestation-rewards.ts)_
