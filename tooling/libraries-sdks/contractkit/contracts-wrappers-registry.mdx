---
title: "Core Contracts (Wrapper/Registry)"
sidebarTitle: "Core Contracts Registry"
...
## Interacting with CELO & USDm

celo-blockchain has two initial coins: CELO and USDm (Mento Dollar stabletoken).
...
To interact with USDm, is the same but with a different contract:
