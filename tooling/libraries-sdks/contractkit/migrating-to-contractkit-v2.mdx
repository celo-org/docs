...
These functions now require an array of fee payable token addresses. You can get these from the CeloTokens class, the Registry, or the [Fee Currencies](/tooling/contracts/token-contracts) list.
