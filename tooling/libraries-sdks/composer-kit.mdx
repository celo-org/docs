...
- 🔧 **Plug-and-play React components** for Celo apps
...
Composer Kit UI provides several categories of components to accelerate your Celo app development:
