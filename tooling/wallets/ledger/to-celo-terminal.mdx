...
sidebarTitle: "Connect to Celo Terminal"
---
...
<Warning>
The Celo Ledger app currently does not support signing EIP-712 typed data, which is required for Safe multisig transactions and certain apps.

If you need to sign EIP-712 transactions, see the [EIP-712 Signing Workaround guide](/tooling/wallets/ledger/eip712-workaround) for detailed instructions on using the Eth Recovery app.
</Warning>