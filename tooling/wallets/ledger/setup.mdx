...
Click **Install** for the Celo app. Ledger Live installs the current version.
...
- [Celo Terminal App](/tooling/wallets/ledger/to-celo-terminal)
- [Celo Web Wallet](/tooling/wallets/ledger/to-celo-web)
- [Celo CLI](/tooling/wallets/ledger/to-celo-cli)
...
If you need to sign EIP-712 transactions, you'll need to use the **Eth Recovery app** as a workaround. See the [EIP-712 Signing Workaround guide](/tooling/wallets/ledger/eip712-workaround) for detailed instructions.
</Warning>