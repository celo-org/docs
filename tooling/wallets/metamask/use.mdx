...
og:description: Overview of MetaMask and how you can get started with MetaMask on Celo.
---
...
While gas on Celo can usually be paid in [many different currencies](/legacy/protocol/transaction/erc20-transaction-fees), when using MetaMask, gas fees will automatically be paid in CELO. This is because MetaMask will be using the [Ethereum-compatible Celo transaction format](https://github.com/celo-org/celo-proposals/blob/master/CIPs/cip-0035.md), which doesn't include the `feeCurrency` field.
