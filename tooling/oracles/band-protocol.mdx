...
sidebarTitle: "Using Band Protocol"
---
...
3. Switch to the Deploy tab of Remix.
   ...
   2. Make sure that Metamask is connected to the Celo Sepolia test network. You can read about adding Celo Sepolia to Metamask [here](/tooling/wallets/metamask/setup#adding-a-celo-network-to-metamask).
...
<Frame>
<img src="/img/doc-images/band-protocol-how-to/get-price.png" alt="get price" width="300" />
</Frame>
...
<Frame>
<img src="/img/doc-images/band-protocol-how-to/getmultiprices.png" alt="get prices" width="300" />
</Frame>
...
<Frame>
<img src="/img/doc-images/band-protocol-how-to/saveprice.png" alt="get prices" width="300" />
</Frame>
