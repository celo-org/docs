...
As part of the [migration from L1 to L2](/about-celo/history), Celo Validators have become [Community RPC providers](contribute-to-celo/community-rpc-nodes/community-rpc-node.mdx).
