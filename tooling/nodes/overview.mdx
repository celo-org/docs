...
[thirdweb](https://thirdweb.com/celo) provides RPC endpoints alongside its contract deployment and SDK tooling.
...
<Card href="https://thirdweb.com/celo" arrow title="thirdweb">
...
[node101](https://node101.io/en/rpc/celo) provides paid Celo JSON-RPC access and managed dedicated nodes. Services include distributed request handling, infrastructure monitoring, and 24/7 technical support. The 101 Dashboard and incident reports are available on Business, Expert, and Enterprise plans. Archive nodes and testnet RPC are available on request. Dedicated deployments can be scoped in Türkiye, Europe, and the United States.

#### Supported networks

- Celo Mainnet
- Celo Sepolia (available on request)

<Card href="https://node101.io/en/rpc/celo" arrow title="node101">
View Celo plans and request access
</Card>

### PublicNode

[PublicNode](https://www.publicnode.com) by Allnodes provides fast, free, and privacy-first RPC endpoints for Celo.

#### Supported Networks

- Celo Mainnet

<Card href="https://celo.publicnode.com" arrow title="PublicNode">
https://celo.publicnode.com
</Card>

### BoltRPC

[BoltRPC](https://boltrpc.io) is a multi-chain RPC provider operated by [Matrixed.Link](https://matrixed.link). Celo Mainnet endpoints support HTTPS, WebSocket, and debug methods; archive access is available on request for qualifying plans. Paid plans only, with a 14-day trial.
