---
title: "Deploy on Celo with Foundry"
sidebarTitle: "Using Foundry"
...
It is recommended to use `--verify` flag so that the contract gets verified right after deployment, this requires [etherscan configuration](/tooling/contract-verification/index#using-foundry) in the `foundry.toml` file.
</Note>
