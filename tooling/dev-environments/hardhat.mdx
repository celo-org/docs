---
title: "Deploy on Celo with Hardhat"
...
[Hardhat](https://hardhat.org/) is a development environment to compile, deploy, test, and debug your Ethereum or Celo software. It helps developers manage and automate the recurring tasks that are inherent to the process of building smart contracts and apps, as well as easily introducing more functionality around this workflow. This means compiling, running, and testing smart contracts at the very core.
...
Choose one of the following items to prepare an app to deploy on Celo.
...
<Tip>
Learn more about building and deploying apps using the <a href="https://hardhat.org/">HardHat documentation</a>.
</Tip>
