...
Getting historical data on a smart contract can be frustrating when you’re building an app. For example the [The Graph](https://thegraph.com/) provides an easy way to query smart contract data through APIs known as subgraphs. The Graph’s infrastructure relies on a decentralized network of indexers, enabling your app to become truly decentralized.
...
- [The Graph](https://thegraph.com/)
  ...
  - [Subgraph Explorer](https://thegraph.com/explorer)
    - The Subgraph Explorer allows you to search and explore subgraphs that have been deployed to The Graph's decentralized network. You can use it to find subgraphs relevant to your app and see how they are structured.
