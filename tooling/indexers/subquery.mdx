---
title: SubQuery
description: Index Celo and cross-chain data with the SubQuery SDK and its decentralised APIs
---
...
- [By publishing it to the decentralised SubQuery Network](https://academy.subquery.network/indexer/run_publish/introduction.html#publish-to-the-subquery-network), the most open, performant, reliable, and scalable data service for app developers.
