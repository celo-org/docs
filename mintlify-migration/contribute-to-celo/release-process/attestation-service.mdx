---
title: "Attestation Service Release Process"
sidebarTitle: "Attestation Service"
og:description: Details of the release process for updating the attestation service on the Celo platform.
---
