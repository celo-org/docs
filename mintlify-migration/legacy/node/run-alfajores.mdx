---
title: "Run an Alfajores Full Node"
sidebarTitle: "Alfajores Full Node"
og:description: How to run a full node on the Alfajores Network using a prebuilt Docker image.
---
