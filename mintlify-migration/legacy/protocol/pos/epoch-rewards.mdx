...
- Distribute [rewards to holders of Locked CELO](/about-celo/protocol/epoch-rewards/index) voting for groups that elected validators
- Make payments into a [Community Fund](/about-celo/protocol/epoch-rewards/community-fund) for protocol infrastructure grants
- Make payments into a [Carbon Offsetting Fund](/about-celo/protocol/epoch-rewards/carbon-offsetting-fund) for carbon offsetting projects
