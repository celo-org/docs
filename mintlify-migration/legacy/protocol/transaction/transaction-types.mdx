...
og:description: This page contains an explainer on transaction types supported on Celo and a demo to make specific transactions.
---
...
| <InlineImage src="/img/doc-images/transaction-types/Ethereum.png" /> | Access list transaction    | `1`   | [EIP-2930](https://eips.ethereum.org/EIPS/eip-2930) ([CIP-35](https://github.com/celo-org/celo-proposals/blob/master/CIPs/cip-0035.md))                       | ❌          | Active 🟢 | Does not support dynamically changing _base fee_ per gas |
| <InlineImage src="/img/doc-images/transaction-types/Ethereum.png" /> | Legacy transaction         | `0`   | [Ethereum Yellow Paper](https://ethereum.github.io/yellowpaper/paper.pdf) ([CIP-35](https://github.com/celo-org/celo-proposals/blob/master/CIPs/cip-0035.md)) | ❌          | Active 🟢 | Does not support dynamically changing _base fee_ per gas |
...
| Client library        | Language | <InlineImage src="/img/doc-images/transaction-types/Ethereum.png" /> | since | <InlineImage src="/img/doc-images/transaction-types/Celo.jpg" /> | since                                                                       | Comment                                          |
| --------------------- | :------: | :---------------------------------------------------------------------: | :---: | :------------------------------------------------------------------ | --------------------------------------------------------------------------- | ------------------------------------------------ |
| `viem`                |  TS/JS   |                                   ✅                                    |       | ✅                                                                  | >[1.19.5][1]                                                                | ---                                              |
