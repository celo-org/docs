---
title: "Add Stable Assets"
sidebarTitle: "Add Stable Assets to Celo"
og:description: Overview of the requirements and steps to add a new stable asset to the Celo platform.
---
