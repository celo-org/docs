---
title: "Celo Protocol"
sidebarTitle: "Celo Payments SDK"
og:description: Celo’s Pay is a standard protocol along with a few reference implementations on how developers can integrate decentralized payments into their dApps, wallets and services.
---
...
For the server to know about your DEK, your account created above _needs_ to be [registered](/cli/account#celocli-accountregister) and have the public key of your DEK [registered too](/cli/account#celocli-accountregister-data-encryption-key).
