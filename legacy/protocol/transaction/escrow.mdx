---
title: "Escrow (Celo L1)"
sidebarTitle: "Celo's Escrow Contract"
og:description: Introduction to the Celo Escrow contract and how to use it to withdraw, revoke, and reclaim funds.
---
