...
og:description: Introduction to locked CELO and how to use validator elections to participate in voting.
sidebarTitle: "Locked CELO"
---
...
Participants can follow the steps [here](/home/protocol/governance/voting-in-governance-using-mondo#vote-delegation) to perform delegation using CeloCLI.