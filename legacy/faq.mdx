...
<Accordion title="My Alfajores node stalled at the Isthmus hardfork block (49908280)">
...
<Accordion title="What is the current testnet">

The current testnet is Celo Sepolia, which launched on September 13, 2025
, replacing the Alfajores testnet.

Celo Sepolia operates settles on the Sepolia testnet.
</Accordion>

<Accordion title="What’s the difference between Dango and Alfajores?">
...
Alfajores was a long running Celo network testnet that was [launched in July 2019](https://blog.celo.org/introducing-alfajores-1b162ebcb44d), upgraded to L2 in September 2024, and deprecated in September 2025.
