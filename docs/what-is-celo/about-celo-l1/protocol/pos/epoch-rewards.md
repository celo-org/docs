...
For the most up-to-date information, refer to our [Celo L2 documentation](https://docs.celo.org/cel2) or the new [epoch rewards page](/what-is-celo/using-celo/protocol/epoch-rewards/index).
:::
