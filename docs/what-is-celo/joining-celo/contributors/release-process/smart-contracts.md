  ...
  <tr>
    ...
    <td>
      <ol>
        ...
        <li>
          Implement the{" "}
          <a href="/what-is-celo/joining-celo/contributors/release-process/smart-contracts#When-a-new-release-branch-is-cut">git management steps</a>{" "}
    ...
    <td>
      <ol>
        ...
        <li>
          ...
          <a href="/what-is-celo/joining-celo/contributors/release-process/smart-contracts#During-the-release-proposal-stage">
  ...
  <tr>
    ...
    <td>
      <ol>
        <li>
          On Tuesday: Run the{" "}
          <a href="/what-is-celo/joining-celo/contributors/release-process/smart-contracts#release-process">smart contract release script</a>{" "}
  ...
  <tr>
    ...
    <td>
      <ol>
        ...
        <li>
          Run the{" "}
          <a href="/what-is-celo/joining-celo/contributors/release-process/smart-contracts#release-process">
  ...
  <tr>
    ...
    <td>
      <ol>
        ...
        <li>
          On Tuesday: Run the{" "}
          <a href="/what-is-celo/joining-celo/contributors/release-process/smart-contracts#build-process">
            smart contract release script
          </a>{" "}
        ...
        <li>
          ...
          <a href="/what-is-celo/joining-celo/contributors/release-process/smart-contracts#verify-release-process">verify</a> the proposed contracts
