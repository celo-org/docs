---
title: Using Band
description: Tutorial on how to use Band on Celo, the Unified Data Layer for AI and Web3
---

import ImageWrapper from '@components/ImageWrapper'

By the end of this tutorial, you will understand how to query [Band](https://www.bandprotocol.com/) reference data smart contract from another Solidity smart contract on Celo.
...
[Band](https://bandprotocol.com/) is the data layer that trains AI engines and powers blockchain applications. By empowering DeFi, GameFi, and AI agents, it enables developers, institutions, and users to access real-time data with zero counterparty risk. With Band’s open, battle-tested data infrastructure built for blockchains and LLMs, it ensures that real-time information is always accessible—fueling everything from financial protocols to autonomous AI systems. You can read more about the specific details of the protocol [here](https://docs.bandchain.org/).
...
3. Switch to the Deploy tab of Remix.
   ...
   2. Make sure that Metamask is connected to the Celo Sepolia test network. You can read about adding Celo Sepolia to Metamask [here](/wallet/metamask/setup#adding-a-celo-network-to-metamask).
