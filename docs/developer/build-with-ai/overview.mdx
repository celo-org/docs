...
You can find many example for quite advanced agents in this thread (01/20/2025), hosted my Nader Dabit.
...
- Infinite Regen by Owoki: Infinite Regen AI is a platform that creates AI agents trained on the insights of key web3 thought leaders to explore and design new mechanisms for funding public goods.
