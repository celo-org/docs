...
4. To enable the Celo testnet, Alfajores L2, you need to toggle "Use test net".
...
5. Navigate into the "Developer Settings", enable the "Developer Mode" and click "Load Test Page". A popup to enter a URL should apprear.
...
6. Enter the URL of your DApp and click on "Go". You should now get redirected to the site tester.
