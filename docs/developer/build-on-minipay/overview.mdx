...
This guide provides information on how to [develop](#create-minipay-dapp) and [test](#test-your-dapp-inside-minipay) your dApp for MiniPay. 
...
#### 2. Create Your MiniPay dApp Using the Celo Composer MiniPay Template {#create-minipay-dapp}
