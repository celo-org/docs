...
This guide provides information on how to [develop](2-create-your-minipay-dapp-using-the-celo-composer-minipay-template) and [test](#test-your-dapp-inside-minipay) your dApp for MiniPay. 
