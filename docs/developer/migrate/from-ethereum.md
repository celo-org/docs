...
[This tutorial](/developer/walkthrough/hellocontracts) goes over how to start an ultralight node that runs locally and use it to deploy a contract to the Alfajores testnet using Truffle.
