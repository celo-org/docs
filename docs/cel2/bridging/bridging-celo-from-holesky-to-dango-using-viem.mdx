...
In this tutorial, you will learn how to programmatically bridge CELO from Holskey to Dango using the [Optimism SDK](https://docs.optimism.io/builders/chain-operators/tutorials/sdk).  
...
As you can see, we have created a `dango.js` file, in which we have all the data defined that we need to interact with the test network. As Dango will be a shortlived testnet, you won't be able to get the chain data through viem or wagmi. 
