...
If you don't have enough CELO, you can practice the registration process on the [Celo Sepolia](/network/sepolia). Use the [testnet faucet](https://faucet.celo.org/celo-sepolia) to get test CELO - select "Advanced Needs" when requesting funds for RPC provider testing.
