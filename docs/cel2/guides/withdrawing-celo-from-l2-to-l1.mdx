...
<Tabs>
  <TabItem value="index.js" label="index.js" default>
    ...
    import { celo-sepolia } from "./celo-sepolia.js";
  ...
  <TabItem value="celo-sepolia.js" label="celo-sepolia.js">

```js
import { defineChain } from "viem";

const sourceId = 17000; // sepolia

export const celo-sepolia = defineChain({
  ...
  blockExplorers: {
    default: {
      ...
      apiUrl: "hhttps://celo-sepolia.blockscout.com/api/v2",
    },
  },
  testnet: true,
});
