...
Celo will become an ERC20 token on Ethereum and users will be able to use the native bridge to move between the Celo L2 and Ethereum.
The Celo Mainnet bridge can be accessed at [Superbridge](https://superbridge.app/celo).
The Alfajores testnet bridge can be accessed [here](https://testnets.superbridge.app/celo-alfajores).
