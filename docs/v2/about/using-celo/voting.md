...
Celo uses a formal onchain governance mechanism to manage and upgrade the protocol. More information about our governance system can be found in the [Governance Section](/about/ecosystem/governance) of the docs.
