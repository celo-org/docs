      ...
      <ol>
        ...
        <li>
          ...
          <ol>
            ...
            <li>
              {" "}
              Add any initialization data to the CGP that should be included as part
              of the proposal
            </li>
            <li>
              {" "}
              Announce forthcoming smart contract release on: https://forum.celo.org/c/governance
            </li>
          </ol>
        </li>
  ...
  <tr>
    ...
    <td>
      <ol>
        <li>
          On Tuesday: Run the{" "}
          <a href="#release-process">smart contract release script</a> in order
          to to deploy the contracts to Baklava as well as submit a governance
          proposal.
          <ul>
            <li>
  ...
  <tr>
    ...
    <td>
      <ol>
        ...
        <li>
          Run the <a href="#release-process">smart contract release script</a>{" "}
    ...
    <td>
      <ol>
        ...
        <li>
          ...
          <a href="/celo-codebase/protocol/governance">governance process.</a>
          <ul>
            <li>
