  ...
  <tr>
    ...
    <td>
      <ol>
        <li>
          On Tuesday: Run the{" "}
          <a href="#build-and-release-process">smart contract release script</a>{" "}
          in order to to deploy the contracts to Baklava as well as submit a
          governance proposal.
          <ul>
            <li>
              Transition proposal through Baklava{" "}
              <a href="https://docs.celo.org/celo-codebase/protocol/governance">
                {" "}
                governance process.
              </a>
            </li>
            <li>
              Tag the commit that is being proposed with{" "}
              <code>celo-core-contracts-v${N}.baklava</code>
            </li>
          </ul>
        </li>
        <li>
  ...
  <tr>
    ...
    <td>
      <ol>
        ...
        <li>
          Tag the commit that is being proposed with{" "}
          <code>celo-core-contracts-v${N}.alfajores</code>
        </li>
        <li>
  ...
  <tr>
    ...
    <td>
      <ol>
        ...
        <li>
          Tag the commit that is being proposed with{" "}
          <code>celo-core-contracts-v${N}.mainnet</code>
        </li>
        <li>
