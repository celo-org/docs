...
* [Configure a Metamask Desktop or Web Wallet to Work with Celo](using-metamask-with-celo/manual-setup)
* [Setup a Ledger to Work with MetaMask to Work With Celo](using-metamask-with-celo/using-a-ledger-with-metamask)

### **For developers:**

* [Setup Metamask to Work with Your dApp](using-metamask-with-celo/programmatic-setup)
...
Celo and Ethereum use different derivation paths for generating seed phrases. Because MetaMask does not let you specify a derivation path to use:
  ...
  * See these guides if you accidentally sent [ETH to CELO addresses](../../celo-owner-guide/celo-recovery) or [CELO to ETH addresses.](../../celo-owner-guide/eth-recovery)
