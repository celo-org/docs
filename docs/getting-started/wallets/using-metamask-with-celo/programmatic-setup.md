...
1. Add the Network
2. Add Celo Mento stable tokens \(e.g. cUSD, cEUR\)
...
## Adding Mento stable tokens \(e.g. cUSD, cEUR\)
...
- Where it says `INSERT_SYMBOL_HERE`, please replace with the correct symbol for the Mento asset you'd like to watch. For Celo Dollars, it's `cUSD` and for Celo Euros, it's `cEUR`.
