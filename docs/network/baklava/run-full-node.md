...
You will have fully synced with the network once you have pulled the latest block number, which you can lookup by visiting the [Baklava Block Explorer](https://baklava-blockscout.celo-testnet.org/).
