...
const Users: User[] = [
...

  {
    ...
    website:
      "/blog/tutorials/a-comparison-of-hardware-software-and-human-oracles",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/exclusive-list-of-hardware-wallets-that-support-the-celo-network",
  ...
  {
    title:
      " A Comprehensive Guide to Comparing Hardware and Software Wallets on Celo",
    description:
    ...
    website:
      "/blog/tutorials/a-comprehensive-guide-to-comparing-hardware-and-software-wallets-on-celo",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/preventing-vulnerabilities-in-solidity-ownership-attack",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/introduction-to-erc-20r-and-reversible-transactions",
    tags: ["beginner", "celosage"],
  },
  {
    ...
    website:
      "blog/tutorials/exploring-the-robust-structure-of-celo-protocol-design",
    tags: ["intermediate", "celosage"],
  },
  {
    title: "Introducing Celo Sage",
    ...
    website:
      "blog/tutorials//preventing-vulnerabilities-in-solidity-reentrancy-attack",
    tags: ["intermediate", "celosage"],
  },
  {
    title:
      "Como usar a metodologia de gestão de produtos para criar soluções com NFT",
    description:
    ...
    website:
      "blog/tutorials/como-usar-a-metodologia-de-gestao-de-produtos-para-criar-solucoes-com-NFT",
  ...
  {
    title:
      "Product Discovery é a chave para criar produtos de NFT de sucesso no blockchain Celo",
    description:
    ...
    website:
      "blog/tutorials/product-discovery-a-chave-para-criar-produtos-de-NFT-de-sucesso-no-blockchain-Celo",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/buy-me-a-coffee-android-app-using-the-celo-java-sdk",
    tags: [
      "celosage",
      "android",
      "celo",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/a-technical-overview-of-celo-light-client-protocol",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/cryptography-in-blockchain-an-overview-of-hash-functions-and-digital-signatures",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/build-a-decentralized-parking-ticket-payments-dapp-on-celo",
    tags: ["celosage", "intermediate", "solidity", "hardhat", "smartcontract"],
  },
  {
    title:
      "Build a FullStack Token Swap Application on Celo using React and 0x API",
    description:
    ...
    website:
      "/blog/tutorials/build-a-fullStack-token-swap-application-on-celo-using-react-and-0x-api",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/build-your-own-full-stack-token-airdrop-dapp-on-celo-blockchain",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/blockchain-basics-an-introduction-to-web3-terms-and-concepts-with-celo",
    tags: ["celosage", "beginner"],
  },
  {
    title:
    ...
    website:
      "blog/tutorials/como-construir-e-realizar-deploy-de-contratos-Factory-no-blockchain-Celo",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/como-criar-um-jogo-de-roleta-russa-na-blockchain-celo",
    tags: ["advanced", "celosage", "smartcontract", "video", "hardhat"],
  },
  {
    title:
      "Aprenda solidity e como criar os primeiros smart contract usando a IDE Remix",
    description:
    ...
    website:
      "blog/tutorials/Aprenda-solidity-e-como-criar-os-primeiros-smart-contract-usando-a-IDE-Remix",
    tags: [
      "beginner",
      "celosage",
      "openzeppelin",
  ...
  {
    title:
      "A Solidity Smart Contract For Auctioning Flowers On The Celo Blockchain",
    description:
    ...
    website:
      "blog/tutorials/A-Solidity-Smart-Contract-For-Auctioning-Flowers-On-The-Celo-Blockchain",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/como-implantar-um-contrato-inteligente-ERC721-usando-a-API-Tatum",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/como-integrar-seu-smart-contract-ao-oraculo-da-redstone-finance",
    tags: ["celosage", "video", "advanced", "celo", "solidity", "hardhat"],
  },
  {
    title:
      "Como enviar e verificar um contrato na blockchain Celo com o hardhat-celo",
    description:
    ...
    website:
      "blog/tutorials/como-enviar-e-verificar-um-contrato-com-hardhat-celo",
  ...
  },
  {
    ...
    website:
      "https://docs.celo.org/blog/2022/07/15/csharp-mobile-app-to-display-celo-nfts",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/floralNft-smart-contract-for-buying-and-gifting-flowers-as-nfts",
  ...
  {
    title:
      "Step-by-Step Guide to Deploying your First Full-Stack Dapp on Celo.",
    ...
    website:
      "/blog/tutorials/step-by-step-guide-to-deploying-your-first-full-stack-dapp-on-celo",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/dynamic-nft-creation-using-svg-to-build-in-smart-contract-on-celo",
    tags: ["intermediate", "solidity", "celosage", "erc721", "truffle"],
  },
  {
    title:
      "How to deploy a celo composer application on spheron protocol(decentralized cloud storage).",
    description:
    ...
    website:
      "/blog/tutorials/how-to-deploy-a-celo-composer-application-on-spheron-protocol",
    tags: [
      "intermediate",
      "composer",
      "dapp",
  ...
  {
    title:
      "Using Witnet.io Oracle to Connect Smart Contracts to Off-Chain Data with Celo",
    description:
    ...
    website:
      "/blog/tutorials/using-witnetio-oracle-to-connect-smart-contracts-to-off-chain-data-with-celo",
    tags: ["intermediate", "solidity", "celosage", "erc721", "truffle"],
  },
  {
    title:
    ...
    website:
      "blog/2022/06/21/composer-series-build-a-crowdfunding-refi-dApp-with-celo-composer",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/exploring-solidity-low-level-features-abi-encoding-and-opcodes",
    tags: ["celosage", "intermediate"],
  },
  {
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-assemble-a-web3-dream-team-and-build-a-high-value-dapp",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/leveraging-the-power-of-smart-contracts-to-enhance-voting-security",
    tags: ["celo", "intermediate", "solidity", "celosage"],
  },
  {
    title:
      "How to Build a Full Stack Dapp For Selling Football Tickets on Celo",
    description:
    ...
    website:
      "blog/tutorials/how-to-build-a-fullstack-dapp-for-selling-football-tickets-on-celo",
  ...
  {
    title:
      "How to Write Upgradable Smart Contracts and Deploy to the Celo Blockchain",
    description:
    ...
    website:
      "blog/tutorials/how-to-write-upgradable-smart-contracts-and-deploy-to-the-celo-blockchain",
  ...
  },
  {
    ...
    preview: require("./showcase/beginner/introduction-to-creating-nfts-on-celo.png"),
    website:
      "https://medium.com/celodevelopers/introduction-to-creating-nfts-on-celo-eb7240a71cc0",
    tags: ["beginner", "foundation", "nft", "erc721"],
  },
  {
    title:
      "Introduction to Zero-Knowledge Technology and its Blockchain Applications",
    description:
      "This tutorial is an introduction to zero-knowledge technology and some use cases in the blockchain space",
    preview: require("./showcase/intermediate/introduction-to-zero-knowledge-technology-and-its-blockchain-applications.png"),
    website:
      "blog/tutorials/introduction-to-zero-knowledge-technology-and-its-blockchain-applications",
    tags: ["celosage", "intermediate"],
  },
  {
    title: " How to Build Car Marketplace dapp Using React",
  ...
  {
    title:
      "How to write a multi-signatures contract on Celo using Hardhat | Part 1/2",
    description:
    ...
    preview: require("./showcase/advanced/how-to-write-a-multi-signatures-contract-on-celo-using-hardhat-part-1-2.png"),
    website:
      "blog/tutorials/how-to-write-a-multi-signatures-contract-on-celo-using-hardhat-part-1-2",
    tags: [
      "celosage",
      "celo",
      "solidity",
  ...
  },
  {
    ...
    preview: require("./showcase/intermediate/unbanked.png"),
    website:
      "/blog/tutorials/celo-impact-on-underbanked-and-unbanked-communities",
    tags: ["celo", "intermediate", "celosage"],
  },
  {
    title: "Celo Integration with Web3",
  ...
  },
  {
    ...
    preview: require("./showcase/advanced/build-an-nft-full-stack-monster-war-game-on-the-celo-blockchain.png"),
    website:
      "blog/tutorials/build-an-nft-full-stack-monster-war-game-on-the-celo-blockchain",
    tags: ["celosage", "nft", "solidity", "celo", "advanced"],
  },
  {
    title: "Build Your Own Full Stack DAO On the Celo Blockchain",
    ...
    preview: require("./showcase/intermediate/build-your-own-full-stack-dao-on-the-celo-blockchain.png"),
    website:
      "blog/tutorials/build-your-own-full-stack-dao-on-the-celo-blockchain",
    tags: ["celosage", "solidity", "celo", "react", "intermediate"],
  },
  {
    title: "Build Your Own Full Stack NFT AI Art Minter On The Celo Blockchain",
    ...
    preview: require("./showcase/intermediate/build-your-own-fullstack-nft-ai-art-minter-on-the-celo-blockchain.png"),
    website:
      "blog/tutorials/build-your-own-full-stack-nft-ai-art-minter-on-the-celo-blockchain",
    tags: ["celosage", "solidity", "celo", "nft", "react", "intermediate"],
  },
  {
    ...
    website:
      "blog/tutorials/celo-composer-customize-your-full-stack-mobile-dapps-on-celo",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/contractkit-a-practical-guide-to-interacting-with-the-celo-core-contracts",
  ...
  {
    title:
      "All you need to know about Celo to Ease your Web3 Development Journey you use Celo Blockchain",
    description:
    ...
    website:
      "/blog/tutorials/All-you-need-to-know-about-Celo-to-Ease-your-Web3-Development-Journey",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/hardhat-and-celo-the-ultimate-guide-to-deploy-celo-dapps-using-hardhat",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/Build-a-Full-Stack-Coffee-Dapp-With-Celo-Composer-and-Solidity",
    tags: [
      "celosage",
      "composer",
      "celo",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-build-a-full-stack-social-media-dapp-on-the-celo-blockchain",
  ...
  },
  {
    ...
    preview: require("./showcase/beginner/the-ultimate-guide-to-deploy-dapps-using-truffle.png"),
    website:
      "blog/tutorials/truffle-and-celo-the-ultimate-guide-to-deploy-celo-dapps-with-truffle",
    tags: ["beginner", "foundation", "truffle"],
  },
  {
    title:
      "Building a Celo Remittance System A Technical Tutorial for Developers",
    description:
    ...
    website:
      "blog/tutorials/building-a-celo-remittance-system-a-technical-tutorial-for-developers",
    tags: [
      "celosage",
      "celowallet",
      "celo",
  ...
  {
    title:
      "Exploring Celo in the Gaming Industry for In-Game Assets and P2P Trading",
    description:
    ...
    website:
      "blog/tutorials/exploring-celo-in-the-gaming-industry-for-in-game-assets-and-p2p-trading",
  ...
  },
  {
    ...
    preview: require("./showcase/beginner/6-steps-to-quickly-build-smart-contracts-on-celo-with-remix.png"),
    website:
      "blog/tutorials/6-steps-to-quickly-build-smart-contracts-on-celo-with-remix",
    tags: ["beginner", "foundation", "remix"],
  },
  {
  ...
  },
  {
    ...
    website:
      "blog/tutorials/celo-cli-a-practical-guide-to-energize-your-celo-toolkit",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/pros-and-cons-of-using-celo-to-create-decentralized-applications",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/a-beginners-guide-to-layer-1-blockchains-socialimpact-refi-defi-and-more",
    tags: ["celosage", "celo", "beginner"],
  },
  {
    ...
    website:
      "/blog/tutorials/unlocking-the-power-of-blockchain-nfts-and-cryptography",
    tags: ["celosage", "celo", "beginner"],
  },
  {
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/deploy-and-interact-with-smart-contracts-on-the-celo-blockchain",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/create-an-escrow-nft-platform-on-celo-with-python",
  ...
  },
  {
    ...
    preview: require("./showcase/intermediate/Auction.png"),
    website:
      "blog/tutorials/Understanding-the-Fundamentals-of-Auction-Programming-in-Solidity",
    tags: ["celo", "intermediate", "celosage"],
  },
  {
    title:
    ...
    preview: require("./showcase/intermediate/celo-governance.png"),
    website:
      "blog/tutorials/Understanding-the-Role-of-Proposals-and-Referendums-in-Celo-Governance",
    tags: ["intermediate", "celo", "celosage"],
  },
  {
    title: "Create a React Based DApp on Celo",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/designing-a-user-friendly-celo-dapp-a-beginners-guide-to-uiux",
  ...
  },
  {
    ...
    website:
      "https://learn.figment.io/tutorials/how-to-run-a-celo-full-node-in-a-virtual-machine",
  ...
  },
  {
    ...
    website:
      "https://learn.figment.io/tutorials/deploying-smart-contracts-on-celo-with-truffle",
    tags: ["beginner", "figment", "solidity", "metamask", "remix"],
  },
  {
    title:
    ...
    website:
      "https://learn.figment.io/tutorials/how-to-successfully-connect-to-a-celo-wallet-with-a-react-native-dapp",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/hackathons-101-everything-you-need-to-know-about-hackathons",
    tags: ["celosage", "beginner"],
  },
  {
  ...
  },
  {
    ...
    website:
      "https://learn.figment.io/tutorials/distributed-file-manager-using-ipfs-celo-reactjs",
  ...
  },
  {
    ...
    website:
      "https://learn.figment.io/tutorials/redeploy-ethereum-dapps-on-celo",
  ...
  },
  {
    ...
    website:
      "https://learn.figment.io/tutorials/create-deploy-and-mint-your-eRC223-contract-on-celo-with-hardhat",
    tags: [
      "intermediate",
      "celo",
      "celosage",
  ...
  },
  {
    ...
    website:
      "/blog/2022/07/27/how-to-create-a-loyalty-program-using-meta-transactions",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/building-a-decentralized-newsfeed-with-celo-composer",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-create-an-upgradeable-smart-contract-in-celo",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/a-practical-comparison-between-erc-1155-and-erc-721",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/understanding-role-based-access-control-in-smart-contracts",
    tags: [
      "celosage",
      "intermediate",
      "solidity",
  ...
  {
    title:
      "Tech Talk: Utilizing the ReFi Stack Thesis to Propel Web3 Project Idea Generation",
    description:
  ...
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=W7nGdHKcIFw&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=6",
    tags: ["beginner", "video"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=ke5OPItFaOQ&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=7",
    tags: ["advanced", "video"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=CxIzZmG2bBI&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=8",
    tags: ["advanced", "video"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=Y0-hzz_QbKg&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=9",
    tags: ["advanced", "video"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=0PL31bwzdKA&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=10",
    tags: ["intermediate", "video"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=B2O6FcgvXAI&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=12",
    tags: ["advanced", "video"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=HIEcAXshU8U&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=13",
    tags: ["intermediate", "video"],
  },
  {
    ...
    website:
      "/blog/tutorials/the-future-of-regenerative-finance-and-its-potential-impact",
    tags: ["beginner", "celo", "celosage"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=O6DjaYFGLmE&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=15",
    tags: ["intermediate", "video"],
  },
  {
    title:
      "Building A Decentralized Investment Platform on the Celo blockchain",
    description:
  ...
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=xxLWRUmAKvs&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=16",
    tags: ["advanced", "video"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=foamzu62nZk&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=18",
    tags: ["beginner", "video"],
  },
  {
    ...
    website:
      "https://www.youtube.com/watch?v=hf5gTAQ8G10&list=PLsQbsop73cfH5QYX9Olfw1fwu0rz3Slyj&index=19",
    tags: ["intermediate", "video"],
  },
  {
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-redeploy-your-ethereum-dApp-to-celo-with-hardhat",
    tags: [
      "intermediate",
      "hardhat",
      "celosage",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-write-unit-testing-for-contracts-with-hardhat",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-create-deploy-and-mint-your-erc1155-token-on-celo-with-hardhat",
    tags: [
      "celo",
      "intermediate",
      "celosage",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-write-unit-testing-for-smart-contract-with-truffle",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-listen-to-smart-contract-on-chain-event-with-celo",
    tags: ["celo", "intermediate", "celosage"],
  },
  {
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-download-and-test-the-Celo-extension-wallet-on-your-browser",
  ...
  {
    title:
      "How to build a marketplace for selling shoes on the celo blockchain",
    description:
    ...
    website:
      "blog/tutorials/how-to-build-a-marketplace-for-selling-shoes-on-the-celo-blockchain",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/advance-hardhat-configuration-on-celo-using-plugins",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/build-an-nft-marketplace-for-tech-artisans-on-celo",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/regenerative-finance-and-celo-the-process-and-partnership",
    tags: ["celosage", "intermediate"],
  },
  {
    title:
    ...
    website:
      "blog/tutorials/best-practices-for-writing-smart-contracts-with-real-world-examples",
    tags: ["celosage", "intermediate", "solidity", "hardhat"],
  },
  {
    ...
    website:
      "blog/tutorials/an-introduction-to-layer-1-and-layer-2-blockchain-protocols",
    tags: ["celosage", "beginner"],
  },
  {
  ...
  },
  {
    ...
    website:
      "blog/tutorials/build-a-generic-staking-dapp-using-foundry-and-nextjs",
    tags: [
      "celosage",
      "advanced",
      "smartcontract",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/connect-and-interact-with-celo-using-web3onboard-library",
    tags: [
      "celosage",
      "intermediate",
      "smartcontract",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/proof-of-work-vs-proof-of-stake-a-comprehensive-comparison",
    tags: ["celosage", "intermediate"],
  },
  {
    ...
    website:
      "blog/tutorials/preventing-vulnerabilities-in-solidity-denial-of-service-attack",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/create-a-crowdfunding-smart-contract-on-celo-using-hardhat",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/build-a-donation-dapp-on-celo-to-award-your-favourite-content-creator",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/create-full-stack-whitelist-dapp-with-merkle-trees-celo",
    tags: ["advanced", "hardhat", "celosage", "solidity"],
  },
  {
    title:
      "Creating a Twitter-Like Decentralized Application on Celo using Solidity",
    description:
    ...
    website:
      "blog/tutorials/building-a-decentralized-twitter-on-the-celo-blockchain",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-use-hardware-tools-with-the-celo-blockchain",
    tags: ["intermediate", "celo", "celosage"],
  },
  {
    ...
    website:
      "blog/tutorials/build-a-feature-rich-persistent-dapp-on-celo-using-wagmi",
    tags: [
      "hardhat",
      "celosage",
      "solidity",
  ...
  },
  {
    ...
    website:
      "/blog/tutorials/why-you-should-build-your-next-project-on-the-celo-blockchain",
    tags: ["celosage", "beginner", "celo"],
  },
  {
    ...
    website:
      "/blog/tutorials/simplifying-the-celo-2.0-roadmap-for-celo-builders",
    tags: ["celosage", "celo"],
  },
  {
    ...
    website:
      "blog/tutorials/how-to-add-support-for-stablecoin-gas-fees-using-celo-composer",
  ...
  {
    title:
      "Build an nft-gated dapp and deploy on a decentralized hosting service",
    ...
    website:
      "blog/tutorials/build-an-nft-gated-dapp-and-deploy-on-decentralized-hosting-service",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/how-to-create-a-decentralized-application-using-react-celo",
    tags: [
      "celosage",
      "smartcontract",
      "solidity",
  ...
  {
    title:
      "Build a Full-Stack Mobile DApp with React Native and Web.JS on Celo",
    description:
    ...
    website:
      "blog/tutorials/build-a-full-stack-mobile-dapp-with-react-native-and-webjs-on-celo",
  ...
  },
  {
    ...
    description:
      "A Celo-based crowdfunding platform for social causes would enabl social organizations, charities, and individuals to create campaigns and connect directly with donors to donate funds, leveraging the transparency and security of blockchain technology.",
    preview: require("./showcase/intermediate/developing-a-crowdfunding-platform-for-social-causes-on-celo-blockchain-part-1.png"),
    website:
      "blog/tutorials/developing-a-crowdfunding-platform-for-social-causes-on-celo-blockchain-part-1",
    tags: ["celosage", "solidity", "intermediate", "celo", "truffle"],
  },
  {
    title:
      "The Future of NFT Creation - Unleashing the Power of Batch Minting with ERC721psi",
    description:
    ...
    website:
      "blog/tutorials/the-future-of-nft-creation-unleashing-the-power-of-batch-minting-with-erc721psi",
  ...
  },
  {
    ...
    website:
      "blog/tutorials/automate-flutter-celo-dapp-deployment-with-github-actions",
