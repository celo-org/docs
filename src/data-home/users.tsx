...
const Users: User[] = [
  ...
  // Get Started with Celo
  {
    ...
    preview: require('./showcase/favorites/wallets.png'),
    website: '/wallet',
    tags: ['favorite'],
  },
  {
    ...
    preview: require('./showcase/favorites/dapps.png'),
    website: '/showcase',
    tags: ['favorite'],
  },
  {
  ...
  // Developers
  {
    ...
    preview: require('./showcase/developers/start-building.png'),
  ...
  },
  {
    ...
    preview: require('./showcase/developers/libraries-and-sdks.png'),
