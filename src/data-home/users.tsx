...
const Users: User[] = [
  ...
  // Get Started with Celo
  {
    ...
    preview: require('./showcase/favorites/choose-a-wallet.png'),
    website: '/wallet',
    tags: ['favorite'],
  },
  {
    ...
    preview: require('./showcase/favorites/use-a-dapp.png'),
    website: '/showcase',
    tags: ['favorite'],
  },
  {
    ...
    preview: require('./showcase/favorites/explore-tutorials.png'),
    website: '/tutorials',
    tags: ['favorite'],
  },
  {
    ...
    preview: require('./showcase/favorites/leave-feedback.png'),
  ...
  // Developers
  {
    ...
    preview: require('./showcase/developers/build-on-celo.png'),
  ...
  },
  {
    ...
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    preview: require('./showcase/developers/sdks.png'),
  ...
  },
  {
    title: 'CLI',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    preview: require('./showcase/developers/cli.png'),
    website: '/cli',
    tags: ['developers'],
  },
