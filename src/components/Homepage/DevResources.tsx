          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <p
                  className={`${index === 3 ? "text-violet-600" : "text-sand"} !font-futura !font-light text-5xl md:text-6xl lg:text-7xl mb-4`}
                >
                  {resource.title}
                </p>
                <p className="!font-futura !font-light text-white/80 mb-6 text-lg">
