...
<CardGroup cols={2}>
  ...
  <Card title="Troubleshooting" icon="triangle-exclamation" href="/operate/operators/troubleshooting">
    Fixes for common node problems, from stalled transactions to sync failures.
  </Card>
...
<CardGroup cols={1}>
  <Card title="Network notices" icon="megaphone" href="/operate/notices/overview">
...
- [Operating a community RPC node](/contribute-to-celo/community-rpc-nodes/community-rpc-node) — run a community RPC node (the tooling calls it a validator) and keep it eligible for rewards.
