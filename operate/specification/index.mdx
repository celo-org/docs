...
description: How the Celo L2 implementation differs from the OP Stack it is built on
---
...
The [L1→L2 migration changes page](/operate/specification/l2-migration) details the differences compared to the Celo L1 blockchain. The Celo L2 is a continuation of the L1 by using its state and providing a high level of compatibility with it.
...
- [Token duality](/operate/specification/token-duality), access native tokens via ERC20
- [Fee Abstraction](/operate/specification/fee-abstraction), pay gas with ERC20 tokens

## Technical Differences

- New [transaction types](/operate/specification/transaction-types) to support Fee Abstraction
- [One new precompile](/operate/specification/token-duality#the-transfer-precompile) to support token duality
- [Changes to finality](/operate/specification/finality)
- The `MaxCodeSize` for newly deployed contracts is increased from 24576 to 65536.

## Deployments

- [Mainnet](/operate/specification/deployments#mainnet)
- [Celo Sepolia testnet](/operate/specification/deployments#celo-sepolia-testnet)
