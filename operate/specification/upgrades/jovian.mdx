...
sidebarTitle: "Jovian"
description: "The Jovian upgrade: Optimism's Jovian hardfork plus Celo transfer precompile and gas pricing changes"
---
...
The [transfer precompile](/operate/specification/token-duality) now warms the `from` and `to` addresses during execution. This aligns with standard EVM behavior where address accesses during value transfers are warmed, ensuring correct gas accounting for subsequent operations on the same address.
