...
description: The transaction types supported on Celo L2, and which ones to use in new applications
---
...
The following tx type is an essential part of Celo's Fee Abstraction feature. For more details, read the CIP linked below, and the [Fee Abstraction section](/operate/specification/fee-abstraction).
