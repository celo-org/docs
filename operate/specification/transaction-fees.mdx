...
description: How transaction fees work on Celo, including the differences from Ethereum and the OP Stack
---
...
- **[Fee Abstraction](/operate/specification/fee-abstraction)**, which allows users to pay for transaction fees in ERC20 tokens instead of CELO and is covered in its own chapter
