...
description: Enable the monitoring stack and track the health and sync status of your Celo node
---
...
If your node is not syncing or has no peers, see [Troubleshooting](/operate/operators/troubleshooting).
