...
description: Node operator changes and activation timings for the Jovian hardfork
---
...
For the full technical specification, see the [Jovian upgrade spec](/operate/specification/upgrades/jovian).
