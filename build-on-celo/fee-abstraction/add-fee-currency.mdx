...
Fee currencies must implement the [IFeeCurrency](https://github.com/celo-org/fee-currency-example) interface, which extends ERC20 with two additional functions used by the Celo blockchain to debit and credit gas fees.
