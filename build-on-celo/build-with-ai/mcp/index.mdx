...
description: Learn about the Model Context Protocol and how to use Celo-specific MCP servers for building AI agents
---
...
- [Celo MCP Server](/build-on-celo/build-with-ai/mcp/celo-mcp)
  - Chain info, balances, gas fees
  - Governance proposals
  - Staking and validators
  - Runs locally (stdio) or as a remote HTTP endpoint
