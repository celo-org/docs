...
2. **Configure VS Code** by adding the MCP server to your settings:
...
3. **Restart VS Code** and verify setup
...
2. **Configure through JetBrains MCP plugin** or IDE settings

### Windsurf Setup

Windsurf has built-in MCP support. Configure through Windsurf's settings interface.
