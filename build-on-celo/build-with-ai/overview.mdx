...
[Celina](/build-on-celo/build-with-ai/mcp/celina) is a third-party, open-source stack that gives an LLM read, prepare, and execute access to Celo mainnet — balances, transfers, DeFi, governance, staking, and Self Agent ID — through an SDK, an MCP server, and a REST API.
