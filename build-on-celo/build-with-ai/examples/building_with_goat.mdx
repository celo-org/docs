...
sidebarTitle: "Using GOAT Framework"
---
...
- **Node.js (v18 or higher) and npm (or yarn) installed.** You can download Node.js from [https://nodejs.org/](https://nodejs.org/).
...
- **An RPC provider URL for the Celo network.** For testing, use the Celo Sepolia testnet RPC: `https://forno.celo-sepolia.celo-testnet.org/`. For production, consider using a dedicated RPC provider like [Ankr](https://www.ankr.com/), [QuickNode](https://www.quicknode.com/), or others.
...
RPC_PROVIDER_URL=https://forno.celo-sepolia.celo-testnet.org/  # Celo Sepolia Testnet (recommended for testing)
