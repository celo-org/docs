---
title: Build with Bridge stablecoin orchestration APIs on Celo
og:description: Integrate Bridge's stablecoin APIs on Celo to add fiat on and off ramps, virtual bank accounts, custodial wallets, and card issuance to your app.
---
