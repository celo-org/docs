...
Sequencer replace the traditional validator role in the L2 architecture. They are responsible for:
...
Sequencer operate on a faster 1-second block time, improving transaction speed and throughput.
