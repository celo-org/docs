...
#### Get credit for your app's activity:

- Add an [attribution tag](/build-on-celo/attribution-tags) to your transactions. MiniPay apps need zero registration — `toDataSuffix(codeFromHostname(location.hostname))` derives a code from your app's hostname automatically.
