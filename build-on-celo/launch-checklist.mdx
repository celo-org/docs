...
description: A comprehensive guide to assist you in launching apps on Celo.
---
...
- [ ] **Attribution Tags**: Add [attribution tags](/build-on-celo/attribution-tags) to your transactions so on-chain activity is credited to your app (used by MiniPay tracking)
...
Make your app discoverable by reporting it on these platforms:

- [ ] [Dapp Radar](https://dappradar.com) - General app directory
