...
description: "Credit on-chain activity back to your app on Celo using ERC-8021 attribution tags."
---

Attribution tags let you mark transactions as coming from your app — so on-chain activity can be credited back to you for programs like MiniPay leaderboards and hackathon tracking. Celo's implementation follows [ERC-8021](https://oxlib.sh/ercs/erc8021/Attribution).
...
If you've been issued a code (`celo_xxxxxxxx`) — for example through a hackathon registration — pass it directly:
...
- [Fund your Project](/build-on-celo/fund-your-project) — grant and funding programs in the Celo ecosystem
