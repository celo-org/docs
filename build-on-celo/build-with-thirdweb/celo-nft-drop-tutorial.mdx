...
2. Visit the [Celo Sepolia Faucet](https://faucet.celo.org/celo-sepolia) to claim test tokens using your wallet address. ***Remember to claim only what you need.***
