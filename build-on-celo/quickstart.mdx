...
description: Scaffold a Celo app in seconds with Celo Composer, the CLI for generating starter kits
---
...
Optimized for building apps that integrate with the MiniPay mobile wallet, with mobile-first design.
