---
title: "Smart Contracts Release Process"
...
Whenever Celo Core Contracts need to be re-initialized, their initialization arguments should be checked into version control under `packages/legacy/protocol/releaseData/initializationData/release${N}.json`.
