...
The Oblivious Decentralized Identifier Service (ODIS) allows for privacy preserving [phone number mappings](/legacy/protocol/identity/odis-use-case-phone-number-privacy), [password hardening](/legacy/protocol/identity/odis-use-case-key-hardening), and other use cases by implementing a rate limited oblivious pseudorandom function (OPRF).
...
- [Domains](/legacy/protocol/identity/odis-domain)
