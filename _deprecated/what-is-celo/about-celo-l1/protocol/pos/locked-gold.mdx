...
Participants can follow the steps [here](/what-is-celo/using-celo/protocol/governance/voting-in-governance-using-mondo#vote-delegation) to perform delegation using CeloCLI.