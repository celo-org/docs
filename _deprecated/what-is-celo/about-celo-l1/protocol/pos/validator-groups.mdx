...
sidebarTitle: "Validator Groups"
og:description: Celo's proof-of-stake mechanism introduces the concept of Validator Groups as intermediaries between voters and validators.
---
...
Both validators and validator groups can use [Accounts Metadata](/legacy/protocol/identity/metadata) to provide unverified metadata (such as name and organizational affiliation) as well as claims that can be verified off-chain for control of third-party accounts. All validators are encouraged to make a verifiable claim for [domain names](/what-is-celo/about-celo-l1/validator/validator-explorer).
