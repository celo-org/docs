  ...
  docs: [
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { type: "doc", label: "Node Sync", id: "wallet/celo-wallet/node-sync" }
          ],
        },
        {
          type: "category",
          label: "Mobile Wallet",
          items: [
            { type: "doc", label: "Mobile Wallet Setup", id: "wallet/mobile-wallet/setup" },
            { type: "doc", label: "Running the Wallet Locally", id: "wallet/mobile-wallet/run-local" },
            { type: "doc", label: "Testnet Faucet", id: "wallet/faucet-testnet" },
          ],
        },
        {
          type: "category",
          label: "Ledger Wallet",
          items: [
            { type: "doc", label: "Ledger Wallet Setup", id: "wallet/ledger/setup" },
            { type: "doc", label: "Connect to Celo Terminal", id: "wallet/ledger/to-celo-terminal" },
            { type: "doc", label: "Connect to Celo Web Wallet", id: "wallet/ledger/to-celo-web" },
            { type: "doc", label: "Connect to Celo CLI", id: "wallet/ledger/to-celo-cli" },
          ],
        },
        {
          type: "doc",
    ...
    // Networks
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: "Disclaimers",
          items: [
            { type: "doc", label: "Mainnet", id: "network/mainnet/disclaimer" },
            { type: "doc", label: "Alfajores Testnet", id: "network/alfajores/disclaimer" },
            { type: "doc", label: "Baklava Testnet", id: "network/baklava/disclaimer" },
          ],
        },
      ],
    },   
    ...
    // Integrations
    {
      ...
      items: [
        ...
        { type: "doc", label: "Checklist", id: "integration/checklist" },
        { type: "doc", label: "Custody", id: "integration/custody" },
        { type: "doc", label: "Listings", id: "integration/listings" },
        { type: "doc", label: "Cloud HSM", id: "integration/cloud-hsm" },
      ],
    },
    // Validators
    {
      ...
      items: [
        { type: "doc", label: "Overview", id: "validator/index" },
        {
          ...
          items: [
            { type: "doc", label: "Mainnet Validator", id: "validator/run/mainnet" },
            { type: "doc", label: "Baklava Validator", id: "validator/run/baklava" },
          ],
        },
        {
          type: "doc",
        ...
        },
        {
          ...
          items: [
            { type: "doc", label: "Summary", id: "validator/key-management/summary" },
            { type: "doc", label: "Key Management", id: "validator/key-management/detailed" },
            { type: "doc", label: "Key Rotation", id: "validator/key-management/key-rotation" },
          ],
        },
        {
          type: "doc",
        ...
        { type: "doc", label: "Monitoring", id: "validator/monitoring" },
        {
          type: "doc",
        ...
        { type: "doc", label: "Running Proxies", id: "validator/proxy" },
        {
          type: "doc",
    ...
    // Holders
    {
      ...
      items: [
        { type: "doc", label: "Overview", id: "holder/index" },
        {
          ...
          label: "Manage",
          items: [
            { type: "doc", label: "Self-Custody", id: "holder/manage/self-custody" },
            { type: "doc", label: "Release Gold", id: "holder/manage/release-gold" },
            { type: "doc", label: "Exchange Assets", id: "holder/manage/exchange" },
            { type: "doc", label: "Asset Management", id: "holder/manage/asset" },
          ],
        },
        {
          type: "category",
          label: "Voting",
          items: [
            { type: "doc", label: "Validator Elections", id: "holder/vote/validator" },
            { type: "doc", label: "Voting on Governance", id: "holder/vote/governance" },
            { type: "doc", label: "Governable Parameters", id: "holder/vote/governance-parameters" },
          ],
        },
        {
          type: "category",
          label: "Recovery",
          items: [
            { type: "doc", label: "Recover from ETH Address", id: "holder/recover/from-eth-address" },
            { type: "doc", label: "Recover from Celo Address", id: "holder/recover/from-celo-address" },
          ],
        },
        {
          type: "link",
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  id:
                    "protocol/pos/epoch-rewards-locked-gold",
                },
                {
                  type: "doc",
                ...
                },
                {
                  ...
                  id:
                    "protocol/pos/epoch-rewards-carbon-offsetting-fund",
                },
              ],
            },
            {
          ...
          items: [
            {
              type: "doc",
              label: "Overview",
              id: "protocol/transactions/index",
            },
            "protocol/transactions/native-currency",
            "protocol/transactions/erc20-transaction-fees",
            "protocol/transactions/gas-pricing",
            "protocol/transactions/escrow",
            "protocol/transactions/tx-comment-encryption",
            "protocol/transactions/full-node-incentives",
          ],
        },
        {
          type: "category",
            ...
            "protocol/identity/encrypted-cloud-backup",
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  label: "Domains",
                  items: [
                    { type: "doc", label: "Overview", id: "protocol/identity/odis-domain" },
                    { type: "doc", label: "Sequential Delay Domain", id: "protocol/identity/odis-domain-sequential-delay-domain" },
                  ],
                },
              ],
            },
