...
<AccordionGroup>
  <Accordion title="Understanding Celo">
    <CardGroup cols={2}>
      <Card title="What is Celo?" icon="info" href="/about-celo">
      ...
      <Card title="Protocol" icon="sitemap" href="/about-celo/protocol">
...
<Accordion title="Developer Tools">
  <CardGroup cols={2}>
    ...
    <Card title="Bridge" icon="link" href="/about-celo/bridged-tokens/bridges">
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="check-to-slot"
    href="/about-celo/protocol/governance/voting-in-governance-using-mondo"
  >
...
<Tip>
  New to Celo? Start with the [Celo Overview](/home/history) for a complete
