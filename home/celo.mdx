...
<CardGroup cols={2}>
  <Card title="Build on Celo" icon="wrench" href="/build-on-celo">
    Explore comprehensive guides, tutorials, and tools to build apps, DeFi protocols, mobile apps, and more on Celo's fast, low-cost blockchain.
  </Card>
  ...
  <Accordion title="Build with Celo">
    <CardGroup cols={2}>
      <Card title="Quickstart" icon="bolt" href="/build-on-celo/build-with-ai/celopedia">
        Build & Deploy your apps in under 5 minutes
      </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Celo Events" icon="lightbulb" href="https://luma.com/user/usr-QJkvU5EML2BJeYc">
    Sign up for upcoming calls, office hours, and workshops
  </Card>
