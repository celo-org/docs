...
The full specification of these mechanisms — transaction types, fee rules, finality, upgrade history — lives in the [Specs section](/operate/specification/index).
...
- [Specs](/operate/specification/index) - The normative protocol specification
