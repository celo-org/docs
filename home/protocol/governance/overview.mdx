...
<Note>
Pleas follow [this guide to create a proposal](/home/protocol/governance/create-governance-proposal), but make sure to go through this page to fully understand the process before you do so.
</Note>
