...
* [**StakedCelo app**](https://app.stcelo.xyz/connect): An application that allows for liquid staking of Celo and voting on Governance proposals.
...
* [**Celo Events**](https://luma.com/user/usr-QJkvU5EML2BJeYc): Sign Up to the next Governance Call.
