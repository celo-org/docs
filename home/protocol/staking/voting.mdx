...
## The Celo Core Co voting policy

As described above, there are many criteria to consider when deciding which group to vote for. While it is highly recommended that all CELO holders do their independent research when deciding which group to vote for, another option is to vote for Validator Groups that have received votes from Celo Core Co.

Celo Core Co follows a validator group voting policy when voting with the CELO that it holds. This policy has been developed by the Celo Core Co board and technical advisors with the express goal of promoting the long-term security and decentralization of the network. Validator Groups have an opportunity to apply for Celo Core Co votes every 3 months, and a new cohort is selected based on past performance and contributions.
