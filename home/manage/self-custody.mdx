...
Now you've locked CELO, you can use it to participate in voting for or against [Governance proposals](/home/protocol/governance/voting-in-governance-using-mondo). You can do this without affecting any vote you have made for Validator Groups.
