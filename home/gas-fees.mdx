...
When using a Celo-optimized wallet, gas fees can be paid with various ERC-20 tokens including USDC, USDT, USA₮, USDm and CELO. For non Celo-optimized wallets, you'll need CELO tokens for gas fees.
