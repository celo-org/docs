...
description: Where to buy and swap CELO across centralized, decentralized, and Celo-native exchanges
---
...
<Info>
This page covers where to buy and swap CELO. For the wider directory of apps and projects built on Celo, see [celo.org/ecosystem](https://celo.org/ecosystem).
</Info>
...
- [Binance](https://www.binance.com/en/trade/CELO_USDT)
